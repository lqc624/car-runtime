...
- M4 待办：S20 决策素材已就绪（S20-enforce决策与试点登记.md：指标口径/决策矩阵/登记表模板/存量宽限草案——阈值 A/B/C 由主理人 T-1 定）；S21 rc 门禁核查（RC-1~RC-6）；S22 预演 13/13 + 1.0-rc 发布；轨道 A（你）：E-1/E-2/E-3 + 试点数据填报（登记表已发）。
